module Mef
  class MefJob < ApplicationJob
    ...
    # transient outage before we give up and relay the failure to the client via
    # after_discard.  See
    # https://dev.to/davidteren/the-15-year-naming-bug-how-rails-finally-got-polynomiallylonger-right-3g36
    MEF_RETRY_ATTEMPTS = 12
